        ...
        <>
            ...
            <div className="px-5 md:px-[15%] py-35">
                ...
                <div className="my-15">
                    ...
                    <Link target="_blank" href={`${project?.live}`} className="flex group items-center gap-2 bg-orange-500 px-8 py-5 text-neutral-900 font-bold rounded-full hover:scale-110 cursor-pointer transition hover:shadow-lg shadow-orange-500/15">
                        <p>View Live Project</p>
                        <img className="h-5 group-hover:-translate-y-1 transition duration-300" src="../external.svg" />
                    </Link>
                    <Link target="_blank" href={`${project?.github}`} className="bg-neutral-900 px-8 py-5 text-[#eae8e0] font-bold rounded-full hover:scale-110 cursor-pointer transition hover:shadow-lg shadow-neutral-500/15">Github</Link>
                </div>
                </div>
            </div>
            <Footer />
