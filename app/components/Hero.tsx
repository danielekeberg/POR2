        ...
        <div className="h-screen relative flex justify-center items-center" style={{ backgroundImage: "url('../hero.jpg')"}}>
            ...
            <div className="z-99">
                ...
                <div className="text-center my-10">
                    <h1 className="text-9xl tracking-tighter font-extrabold">Crafting Digital</h1>
                    <h1 className="text-9xl tracking-tighter font-extrabold text-center bg-gradient-to-r bg-clip-text text-transparent from-orange-500 to-teal-500">Experiences</h1>
                </div>
                <div className="flex justify-center">
                    <p className="text-neutral-400 text-xl w-150 text-center">I design and build interfaces that feel intuitive, look stunning, and push the boundaries of what's possible on the web.</p>
                </div>
                <div className="flex gap-10 justify-center my-10">
                    ...
                    <Link href="../about/" className="bg-neutral-900 px-8 py-5 text-[#eae8e0] font-bold rounded-full hover:scale-110 cursor-pointer transition hover:shadow-lg shadow-neutral-500/15">About Me</Link>
                </div>
            </div>
        </div>
    )
