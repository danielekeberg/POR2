        ...
        <>
            ...
            <div className="px-5 md:px-[15%] my-35">
                <div className="w-2/3">
                    ...
                    <div className="my-5">
                        <h1 className="text-5xl font-extrabold">Frontend developer with a</h1>
                        <h1 className="text-5xl tracking-tighter font-extrabold bg-gradient-to-r bg-clip-text text-transparent from-orange-500 to-teal-500 w-fit">passion for craft</h1>
                    </div>
